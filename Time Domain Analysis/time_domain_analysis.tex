...
\end{equation*}
 ...
 The response is plotted in figure , and it is clear how $i$ rises from it's intial value of $0$ to it's forced value of $\frac{V_0}{R}$. In this 
...
circuit, note that the The\'{e}venin resistance across the capacitor is
\begin{equation*}

...
\begin{tcolorbox}[colback=red!5, colframe=red!75!black, title=\textbf{Example 2.2}, breakable]
\begin{figure}[H]
\centering
\begin{subfigure}{.5\textwidth}
  \centering
...
\begin{tcolorbox}[colback=red!5, colframe=red!75!black, title=\textbf{Example 2.3}, breakable]
...
\begin{subfigure}{.5\textwidth}
  ...
  \begin{tikzpicture}
	...
	{1};
    \addplot[mark=none, red] coordinates {(2,0) (2, 1)};
    \addplot[mark=none, red] coordinates {(3,0) (3, 1)};
    \addplot[mark=none, red] coordinates {(5,0) (5, 1)};
    \addplot[mark=none, red] coordinates {(6,0) (6, 1)};
	\end{axis}
	\end{tikzpicture}
...
\begin{tcolorbox}[colback=red!5, colframe=red!75!black, title=\textbf{Example 3.1}, breakable]

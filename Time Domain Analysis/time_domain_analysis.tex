...
i &= C\frac{dv}{dt}\\
v &= L\frac{di}{dt}vertical pgfplot
\end{empheq}
...
and the total energy turned into heat by the transistor till the response has died out
...
finding where it intersects the y axis, as shown below:

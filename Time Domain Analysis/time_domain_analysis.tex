...
Find a value of $R_1$ such that the circuit in figure \ref{fig:critical_parallel_rlc} will be characterized by a critically damped response for $t>0s$, and a value of $R_2$ such that $v(0) = 2\si{\volt}$
...
\label{fig:critical_parallel_rlc}
\end{figure}
